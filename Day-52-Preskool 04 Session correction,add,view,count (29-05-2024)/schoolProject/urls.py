...
from schoolProject.sessionyearviews import *
...
urlpatterns = [
    ...
    #_______________Session-Pages_______________#
    path('sessionadd/',sessionadd,name='sessionadd'),
    path('sessionlist/',sessionlist,name='sessionlist'),
    path('sessiondelete/<str:sessionid>',sessiondelete,name='sessiondelete'),
