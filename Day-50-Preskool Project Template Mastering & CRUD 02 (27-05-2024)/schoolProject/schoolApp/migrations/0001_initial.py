# Generated by Django 5.0.6 on 2024-05-27 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Section', models.CharField(choices=[('3', 'C'), ('1', 'A'), ('2', 'B'), ('4', 'D')], max_length=100)),
                ('Date_of_Birth', models.DateField()),
                ('Department_Name', models.CharField(max_length=100)),
                ('Religion', models.CharField(max_length=100)),
                ('Mobile_Number', models.CharField(max_length=100)),
                ('Session_Year', models.CharField(choices=[('2', 'Fall Session'), ('3', 'Spring Session'), ('1', 'Summer Session')], max_length=100)),
